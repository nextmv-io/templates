"""
This script updates one or more templates by:
...
parser = argparse.ArgumentParser(description="Update templates in S3.")
parser.add_argument(
    "--apps",
    "-a",
    type=str,
    help="Apps to release, with the version. Example: java=v1.0.0,python=v1.0.0",
    required=True,
)
parser.add_argument(
    "--bucket",
